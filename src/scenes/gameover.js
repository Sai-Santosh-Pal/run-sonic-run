...
export default function gameover(citySfx) {
    ...
    k.add([
        k.text("GAME OVER", { font: "mania", size: 96 }), k.pos(k.center().x, k.center().y - 300), k.anchor("center"),
    ]);
    k.add([
        k.text(`BEST SCORE : ${bestScore}`, { font: "mania", size: 64 }), k.pos(k.center().x - 400,k.center().y - 200), k.anchor("center"),
    ]);
    k.add([
        k.text(`CURRENT SCORE : ${currentScore}`, { font: "mania", size: 64 }), k.pos(k.center().x + 400, k.center().y - 200), k.anchor("center"),
    ]);
